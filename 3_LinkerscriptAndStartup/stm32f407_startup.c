...
void CAN1_TXIRQHandler				(void) __attribute__ ((weak, alias("Default_Handler")));
void CAN1_RX0IRQHandler				(void) __attribute__ ((weak, alias("Default_Handler")));
void CAN1_RX1IRQHandler				(void) __attribute__ ((weak, alias("Default_Handler")));
void CAN1_SCEIRQHandler				(void) __attribute__ ((weak, alias("Default_Handler")));
...
uint32_t vector_tbl[] __attribute__((section(".isr_vector_tbl")))={
  ...
  (uint32_t)&CAN1_TXIRQHandler,                            			/* CAN1 TX interrupt                                                           */
  (uint32_t)&CAN1_RX0IRQHandler,                            		/* CAN1 RX0 interrupt                                                           */
  (uint32_t)&CAN1_RX1IRQHandler,                            		/* CAN1 RX1 interrupt                                                           */
  (uint32_t)&CAN1_SCEIRQHandler,                            		/* CAN1 SCE interrupt                                                           */
  ...
  (uint32_t)&TIM6_DAC_IRQHandler,                            		/* TIM6 global interrupt, DAC1 DAC2 underrun error interrupts                                                           */
  ...
  (uint32_t)&ETH_WKUP_IRQHandler,                            		/* Ethernet wake up through EXTI line interrupt                                                           */
  ...
  (uint32_t)&OTG_HS_WKUP_IRQHandler,                            	/* USB On The Go HS wake up through EXTI interrupt                                                           */
