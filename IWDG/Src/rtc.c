...
#define WEEKDAY_SUNDAY		((uint8_t)0x7U)
#define MONTH_APRIL			((uint8_t) 4U)
#define TIME_FORMAT_AM		0 // se non funziona prova ~(1U<<22)
#define CR_FMT				(1U<<6)
#define ISR_RSF				(1U<<5)
